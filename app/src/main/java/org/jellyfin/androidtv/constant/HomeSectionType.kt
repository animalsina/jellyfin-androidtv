...
enum class HomeSectionType(
	...
	RANDOM_MOVIES("randommovies", R.string.home_section_random_movies),
	RANDOM_SERIES("randomseries", R.string.home_section_random_series),
	UNWATCHED_RANDOM_MOVIES("unwatchedrandommovies", R.string.home_section_unwatched_random_movies),
	LONG_AGO_MOVIES("longagomovies", R.string.home_section_long_ago_movies),
	...
	PLUTO_ACTION("plutoaction", R.string.home_section_pluto_action),
	PLUTO_COMEDY("plutocomedy", R.string.home_section_pluto_comedy),
	PLUTO_DRAMA("plutodrama", R.string.home_section_pluto_drama),
	PLUTO_THRILLER("plutothriller", R.string.home_section_pluto_thriller),
	PLUTO_DOCUMENTARY("plutodocumentary", R.string.home_section_pluto_documentary),
	PLUTO_SCIFI("plutoscifi", R.string.home_section_pluto_scifi),
	RAIPLAY_FILM("raiplayfilm", R.string.home_section_raiplay_film),
	RAIPLAY_SERIES("raiplayseries", R.string.home_section_raiplay_series),
