...
class UserSettingPreferences(
	...
	companion object {
		...
		val homesection6 = enumPreference("homesection6", HomeSectionType.INCOMPLETE_SERIES)
		val homesection7 = enumPreference("homesection7", HomeSectionType.SEASONAL_EVENTS)
		val homesection8 = enumPreference("homesection8", HomeSectionType.EXTERNAL_PROVIDERS)
		val homesection9 = enumPreference("homesection9", HomeSectionType.ONLINE_NEW_RELEASES)
